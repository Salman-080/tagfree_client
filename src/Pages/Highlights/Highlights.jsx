    ...
    return (
        <div className="" >
            ...
            <div className="md:flex md:justify-around ">
                ...
                {/* <div className="hidden md:flex w-[70px] h-[70px] md:h-[200px] md:w-[200px] lg:h-[500px] lg:w-[500px] md:mt-8 lg:mt-9 md:mr-16 lg:mr-0 border">
                    <img className="h-full w-full  " src="/banner_img_12.png" alt="" />
                </div> */}
                {/* <div style={{ backgroundImage: "url(/banner_img_12.png)" }} className="border hidden md:flex w-[70px] h-[70px] md:h-[200px] md:w-[200px] lg:h-[400px] lg:w-[400px] md:mt-8 lg:mt-9 md:mr-16 lg:mr-0 bg-cover bg-no-repeat rounded-full">
                    <img className="h-full w-full  " src="/banner_img_1.png" alt="" />
                </div> */}
