        ...
        <div className="flex flex-col-reverse md:flex-row ">
            <div className="relative mt-12 hidden md:flex">
                ...
                <div className="hidden md:flex">
                    ...
                    <img className="md:h-[70px] md:w-[50px] lg:h-[120px] lg:w-[80px] absolute md:left-28 lg:left-48 md:top-[31%] lg:top-[36%]" src="/circle.png" alt="" />
                    <img className="md:h-[70px] md:w-[50px] lg:h-[120px] lg:w-[80px] absolute md:left-12 lg:left-24 md:bottom-28  lg:bottom-10" src="/circle.png" alt="" />
            ...
            <div className="text-center space-y-12 lg:ml-36 mt-4">
                ...
                <div className=" space-y-2">
                    <h2 className="text-white text-4xl font-semibold">LONG BATTERY LIFE</h2>
                    <p className="text-gray-400 text-lg">
